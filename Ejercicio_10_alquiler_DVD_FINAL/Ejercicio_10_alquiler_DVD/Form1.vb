Public Class Form1
    ...
    Private Sub DevolverToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles DEVOLVERToolStripMenuItem.Click
        ...
        If opcion <> "" Then
            ...
            If coleccionDVD(opcion).GetSet_AlquiladoDvd() = True Then
                ...
                For i As Integer = 0 To arrayDvd.Length - 1
                    If arrayDvd(i).codDvdAlqui = opcion Then
                        ...
                        boolDevol = True
                            ...
                            coleccionDVD(arrayDvd(i).codDvdAlqui).GetSet_AlquiladoDvd() = False
                ...
                Next
            Else
                MsgBox("Antes deber haber algún DVD alquilado.")
